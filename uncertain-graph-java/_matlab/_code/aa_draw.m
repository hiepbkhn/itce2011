...
eps_arr = {'2.0', '4.4', '8.8' , '13.2'};     % as20graph (2.0, 0.5ln, ln, 1.5ln)
eps_arr = {'2.0', '4.9', '9.8' , '14.7'};     % ca-AstroPh
eps_arr = {'2.0', '6.4', '12.7' , '19.1'};     % amazon
...
hold off
legend('true graph','\epsilon_1=2.0','\epsilon_1=0.5ln n','\epsilon_1=ln n','\epsilon_1=1.5ln n');
