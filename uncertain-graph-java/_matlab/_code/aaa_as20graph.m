...
%         aa_compute_util('as20graph', 'as20graph_hrg_50_1000_6474_sample', 10);
% 
...
%         aa_compute_util('as20graph', 'as20graph_hrg_50_1000_6474_1.0_sample', 10);
% 
%     
...
%         aa_compute_util('as20graph', 'as20graph_dendro_50_1000_6474_17.16_sample', 10);
% 
...
%         aa_compute_util('as20graph', 'as20graph_dendro_50_1000_6474_17.16_1.0_sample', 10);    
%     
...
%         aa_compute_util('as20graph', 'as20graph_dendro_50_1000_6474_8.58_sample', 10);
% 
...
%         aa_compute_util('as20graph', 'as20graph_dendro_50_1000_6474_8.58_1.0_sample', 10);        
%     
...
%         aa_compute_util('as20graph', 'as20graph_dendro_50_1000_6474_sample', 10);
% 
...
%         aa_compute_util('as20graph', 'as20graph_config_1k', 10);      
% 
...
%         aa_compute_util('as20graph', 'as20graph_orbis_1k', 10);      
%     
%     
...
% 
% [rel_err2, e_deg_distr2, e_dist_distr2, e_AD2, e_MD2, e_DV2, e_CC2, e_PL2, e_APD2, e_CL2, e_EDiam2, e_Diam2 ] = ...
%         aa_compute_util('as20graph', 'as20graph_tmfpart_4.0', 1);
% 
% [rel_err3, e_deg_distr3, e_dist_distr3, e_AD3, e_MD3, e_DV3, e_CC3, e_PL3, e_APD3, e_CL3, e_EDiam3, e_Diam3 ] = ...
%         aa_compute_util('as20graph', 'as20graph_tmfpart_8.0', 1);

% (numpart=10)
[rel_err1, e_deg_distr1, e_dist_distr1, e_AD1, e_MD1, e_DV1, e_CC1, e_PL1, e_APD1, e_CL1, e_EDiam1, e_Diam1 ] = ...
        aa_compute_util('as20graph', 'as20graph_tmfpart_10_2.0', 1);

[rel_err2, e_deg_distr2, e_dist_distr2, e_AD2, e_MD2, e_DV2, e_CC2, e_PL2, e_APD2, e_CL2, e_EDiam2, e_Diam2 ] = ...
        aa_compute_util('as20graph', 'as20graph_tmfpart_10_4.0', 1);

[rel_err3, e_deg_distr3, e_dist_distr3, e_AD3, e_MD3, e_DV3, e_CC3, e_PL3, e_APD3, e_CL3, e_EDiam3, e_Diam3 ] = ...
        aa_compute_util('as20graph', 'as20graph_tmfpart_10_8.0', 1);    
