...
% h_legend = legend('1K','TmF','LDP (k=8)','LDP (k=16)','MD (2,6)', 'HRG-MCMC', 'DER', 'EF', 'Location','northwest');
...
% h_legend = legend('1K','TmF','LDP (k=8)','LDP (k=16)','MD (2,7)', 'HRG-MCMC', 'DER', 'EF', 'Location','northwest');
% set(h_legend,'FontSize',14);
% xlhand = get(gca,'xlabel'); set(xlhand,'string','\epsilon / ln(n)','fontsize',14); 
% set(gca,'Xtick',0.1:0.1:0.5); set(gca,'FontSize', 14);
% ylhand = get(gca,'ylabel'); set(ylhand,'string','modularity','fontsize',14)
...
h_legend = legend('1K','TmF','LDP (k=8)','LDP (k=16)','MD (2,10)', 'HRG-Fixed', 'EFShrink', 'Location','northwest');
set(h_legend,'FontSize',14);
xlhand = get(gca,'xlabel'); set(xlhand,'string','\epsilon / ln(n)','fontsize',14); 
set(gca,'Xtick',0.1:0.1:0.5); set(gca,'FontSize', 14);
ylhand = get(gca,'ylabel'); set(ylhand,'string','modularity','fontsize',14)
...
figure;
plot(epsArr/log_n, dKf1, 's-', epsArr/log_n, TmFf1, 's-', epsArr/log_n, LDPf1(1,:), '*-', epsArr/log_n, LDPf1(2,:), '*-', epsArr/log_n, MDf1, 'o-', epsArr/log_n, HRGmod, 's-', epsArr/log_n, EFf1, 'd-');
xlhand = get(gca,'xlabel'); set(xlhand,'string','\epsilon / ln(n)','fontsize',14); 
set(gca,'Xtick',0.1:0.1:0.5); set(gca,'FontSize', 14);
ylhand = get(gca,'ylabel'); set(ylhand,'string','avg.F1score','fontsize',14)

figure;
plot(epsArr/log_n, dKnmi, 's-', epsArr/log_n, TmFnmi, 's-', epsArr/log_n, LDPnmi(1,:), '*-', epsArr/log_n, LDPnmi(2,:), '*-', epsArr/log_n, MDnmi, 'o-', epsArr/log_n, HRGmod, 's-', epsArr/log_n, EFnmi, 'd-');
xlhand = get(gca,'xlabel'); set(xlhand,'string','\epsilon / ln(n)','fontsize',14); 
set(gca,'Xtick',0.1:0.1:0.5); set(gca,'FontSize', 14);
ylhand = get(gca,'ylabel'); set(ylhand,'string','NMI','fontsize',14)
