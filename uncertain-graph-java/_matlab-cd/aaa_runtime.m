...
%%% amazon, dblp, youtube
dataname_list = {'ca-AstroPh-wcc', 'com_dblp_ungraph', 'com_youtube_ungraph'}; % com_amazon_ungraph
n_list = [17903, 317080, 1134890];   % 334863
m_list = [196972, 1049866, 2987624];    % 925872
...
set(gca,'XTickLabel',{'ca-AstroPh','dblp','youtube'});
set(gca,'FontSize', 14)
...
% set(h_legend,'FontSize', 14)
% xlhand = get(gca,'ylabel'); set(xlhand,'string','\epsilon / ln(n)','fontsize',14);
% ylhand = get(gca,'ylabel'); set(ylhand,'string','runtime (s)','fontsize',14);
% set(gca,'FontSize', 14)
