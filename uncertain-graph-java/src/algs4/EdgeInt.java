 ...
 *  @author Kevin Wayne
 */
public class EdgeInt implements Comparable<EdgeInt> { 

    private final int v;
    private final int w;
//    private final double weight;
    private int weight;	// hiepnh Sep 21, 2015
     ...
     */
    public EdgeInt(int v, int w, int weight) {
     ...
     */
    public int compareTo(EdgeInt that) {
