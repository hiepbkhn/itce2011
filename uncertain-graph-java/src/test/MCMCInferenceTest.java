...
//////////////////////////////////
public class MCMCInferenceTest {

	public static void main(String[] args) throws Exception{
		ClassLoader.getSystemClassLoader().setDefaultAssertionStatus(true);
		System.out.println("MCMCInferenceTest");
...
//		String filename = "_data/" + dataname + ".grph";	// GrphTextReader		
		...
		String node_file = prefix + "_out/" + dataname + "_dendro_" + n_samples + "_" + sample_freq + "_" + burn_factor + "_" + String.format("%.1f",eps1) + "_tree";
...
////		AdjacencyMatrix A = G.getAdjacencyMatrix();
		...
		// 
		DendrogramTest T = new DendrogramTest();
		T.initByGraph(G);
...
//	    Dendrogram.inOrderPrint(T.root_node, true, true);
	    ...
	    List<DendrogramTest> list_T = DendrogramTest.dendrogramFitting(T, G, eps1, burn_factor*G.V(), n_samples, sample_freq, node_file);    
	    System.out.println("logLK = " + T.logLK());
...
////	    System.out.println("#nodes in T : " + nNode);
	    ...
	    for (DendrogramTest T2 : list_T)
	        System.out.println("logLK = " + T2.logLK());
	    
	    // TEST writeInternalNodes(), readInternalNodes()
	    DendrogramTest.writeInternalNodes(list_T, node_file);
