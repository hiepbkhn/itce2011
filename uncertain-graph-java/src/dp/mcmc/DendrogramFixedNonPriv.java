...
public class DendrogramFixedNonPriv extends Dendrogram{
...
//		        this.computeTopLevels();		// already called in computeNodeLevels
	...
	////
	public DendrogramFixedNonPriv copy(){
		DendrogramFixedNonPriv T2 = new DendrogramFixedNonPriv();
...
//		return intNodes;		
	...
	static List<DendrogramFixedNonPriv> dendrogramFitting(DendrogramFixedNonPriv T, UnweightedGraph G, int n_steps, int n_samples, int sample_freq, 
			String node_file) throws IOException{
		
		List<DendrogramFixedNonPriv> list_T = new ArrayList<DendrogramFixedNonPriv>(); 	// list of sample T
...
//	            }
 	...
 	////
	static void writeInternalFixedNonPriv(List<DendrogramFixedNonPriv> list_T, String node_file) throws Exception{
	...
	static void readInternalFixedNonPriv(EdgeIntGraph G, List<DendrogramFixedNonPriv> list_T, String node_file, int n_samples) throws Exception{
		int i = 0;
	    for (DendrogramFixedNonPriv T : list_T){
