 ...
 * 
 * Nov 30, 2015
 * 	- copied from Dendrogram.java, remove eps1 from dendrogramFitting()
 */
...
public class DendrogramNonPriv {
	...
	////
	public DendrogramNonPriv(){
		this.root_node = null;
		
	}
	
	////
	public DendrogramNonPriv copy(){
		DendrogramNonPriv T2 = new DendrogramNonPriv();
...
//	}
	...
	static List<DendrogramNonPriv> dendrogramFitting(DendrogramNonPriv T, EdgeIntGraph G, int n_steps, int n_samples, int sample_freq, String node_file) throws IOException{
		List<DendrogramNonPriv> list_T = new ArrayList<DendrogramNonPriv>(); 	// list of sample T
...
//	            }
	...
	public static List<Map<Integer, Integer>> partitionTopDown(DendrogramNonPriv T){
		T.computeTopLevels();
...
//    	
//    	EdgeIntGraph aG = new InMemoryEdgeIntGraph();
...
//                    continue;
	...
	////
	static void writeInternalNodes(List<DendrogramNonPriv> list_T, String node_file) throws Exception{
	    
		int i = 0;
	    for (DendrogramNonPriv T : list_T){
	...
	static void readInternalNodes(EdgeIntGraph G, List<DendrogramNonPriv> list_T, String node_file, int n_samples) throws Exception{
		int i = 0;
	    for (DendrogramNonPriv T : list_T){
