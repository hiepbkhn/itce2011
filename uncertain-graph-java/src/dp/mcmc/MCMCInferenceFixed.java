...
//			eps2 = Double.parseDouble(args[6]);
		...
		String node_file = prefix + "_out/" + dataname + "_fixed_" + n_samples + "_" + sample_freq + "_" + burn_factor + "_" + String.format("%.1f",eps1) + "_tree";
...
//		System.out.println("#edges = " + G.getNumberOfEdges());
	    ...
	    List<DendrogramFixed> list_T = DendrogramFixed.dendrogramFitting(T, G, eps1, burn_factor*G.V(), n_samples, sample_freq, node_file);    
	    System.out.println("logLK = " + T.logLK + " logLK(2) = " + T.logLK());
