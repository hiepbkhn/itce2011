...
//////////////////////////////////
public class MCMCFitEdgeVar {

	public static void main(String[] args) throws Exception{
		ClassLoader.getSystemClassLoader().setDefaultAssertionStatus(true);
		System.out.println("MCMCFitEdgeVar");
...
//		String dataname = "ca-AstroPh";		// (18771,198050) 	28.7k fitting (19.6s)
		...
		//
//		String filename = "_data/" + dataname + ".grph";	// EdgeIntGraphTextReader
		String filename = prefix + "_data/" + dataname + ".gr";	// EdgeListReader
		String node_file = prefix + "_out/" + dataname + "_ev_hrg";
	    String out_file = prefix + "_sample/" + dataname + "_ev_fit";    		
...
//		List<Integer> u_list = HRGEdgeVar.findChildren(T.root_node);
...
//	    HRGEdgeVar.inOrderPrint(T.root_node, true, true);
	    ...
	    List<HRGEdgeVar> list_T = HRGEdgeVar.dendrogramFitting(T, G, burn_factor*G.V(), n_samples, sample_freq);      
	    System.out.println("dendrogramFitting - DONE, elapsed " + (System.currentTimeMillis() - start));

//	    //check T
////	    int nNode = HRGEdgeVar.inOrderPrint(T.root_node, false, false);		// 12947 = 6474*2-1 OK
////	    System.out.println("#nodes in T : " + nNode);
	    
	    for (HRGEdgeVar T2 : list_T)
	    	System.out.println("logLK = " + T2.logLK() + " degDiffL1 = " + T2.degDiffL1() + " edgeVar = " + T2.edgeVar());
	    
	    // TEST writeInternalNodes(), readInternalNodes()
	    HRGEdgeVar.writeInternalNodes(list_T, node_file);
	    System.out.println("writeInternalNodes - DONE");
		
		
//		System.out.println("readInternalNodes");
//	    ArrayList<HRGEdgeVar> list_T2 = new ArrayList<HRGEdgeVar>();
//	    for (int i = 0; i < n_samples; i++)
//	    	list_T2.add(new HRGEdgeVar());
//	    
//	    start = System.currentTimeMillis();
//	    HRGEdgeVar.readInternalNodes(G, list_T2, node_file, n_samples);
//	    for (HRGEdgeVar T2 : list_T2)
