/*
 * vector-unordered-set-op.cpp (replace set by unordered-set)
 *
...
//
vector<unordered_set<int>> read_positive_mc_set(string filename){
...
//
unordered_set<int> set_intersect(unordered_set<int>& s1, unordered_set<int>& s2){
...
//
unordered_set<int> set_differ(unordered_set<int>& s1, unordered_set<int>& s2){
	unordered_set<int> ret;
...
//
PairSetInt find_max_uncovered(vector<unordered_set<int>>& S, int S_size, unordered_set<int>& R) {
	int max_inter_len = 0;
	int max_inter_id = -1;
...
void find_init_cover(vector<unordered_set<int>>& S, int num_element){
	// compute U
...
int main(){
	...
	__int64 start = Timer::get_millisec();
	vector<unordered_set<int>> positive_mc_set = read_positive_mc_set("D:/github/itce2011/mmb_network_cpp/positive_mc_set.0");
