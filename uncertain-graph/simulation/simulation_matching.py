...
@author: huunguye
paper: Graph Pattern Matching: From Intractable to Polynomial Time (VLDB'10)
'''
...
#######################################################
def schematic_similarity(Q, G, labelQ=None, labelG=None):
...
#    Q.add_edges_from([(0,1),(0,2)])
    Q.add_edges_from([(0,1),(0,2),(1,2)])
#    labelQ = {0: 'B', 1: 'B', 2: 'B'}
    labelQ = {0: 'A', 1: 'C', 2: 'D'}       # bad matchings
    ...
    start = time.clock()
    schematic_similarity(Q, G, labelQ, labelG)
