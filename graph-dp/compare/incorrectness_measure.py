...
import scipy.io
from compare import read_two_graphs
...
from entropy_obfuscation import compute_eps, compute_eps_multi
...
#    avg_eps_arr = k_obfuscation_measure_from_file(before_file, after_file, sample_file, n_nodes=100000, k_arr=[30, 50, 100], n_samples=1)  
#    print "eps_arr =", avg_eps_arr

    # for RANDOM WALK
#    avg_eps_arr = k_obfuscation_measure_from_file(before_file, after_file, sample_file, n_nodes=100000, k_arr=[30, 50, 100], n_samples=N_SAMPLES)  
#    print "eps_arr =", avg_eps_arr
